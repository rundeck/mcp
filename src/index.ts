...
// Builds a fresh Server instance with every handler registered. serveStdio()
// (below) pins one instance from this factory per connection — the same
// factory transparently serves both the 2025-era protocol and 2026-07-28,
// so handler logic here needs no era-specific branching.
